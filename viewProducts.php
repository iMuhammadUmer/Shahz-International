                ...
                <div class="logo text-left">
                    <h1>
                        <a class="navbar-brand" href="index.php">
                            <i class="fas fa-podcast"></i> Shahz </a>
                    </h1>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-lg-auto text-right">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link tooltip-blog" href="viewProducts.php">Products</a>
                        </li>
                        
						<li class="nav-item ">
                            <a class="nav-link tooltip-blog" href="project.php">Projects</a>
                        </li>
                        <!-- <li class="nav-item dropdown acitve">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="error.php" title="">404</a>
